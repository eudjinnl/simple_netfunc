...
# macs_input = 'aaaa.bbbb.cccc, 1111.2222.LLLL, 5555.5555.5555'
    ...
    while mac_found == False:
        ...
        if mac in  known_macs:
            ...
            print(f'{mac} has not been found')
                ...
                # elif
                #     previous_dev["dev_name"] = dev_name
                #     previous_dev["dev_ip"] = dev_ip
                #     previous_dev["interface"] = maclist["interface"]
                #     previous_dev["vlan"] = maclist["vlan"]
                
                
                # print(f'{mac} - {dev_name} {dev_ip} {maclist["interface"]} Vlan{maclist["vlan"]}')